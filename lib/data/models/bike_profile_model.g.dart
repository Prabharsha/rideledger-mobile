...
void _bikeProfileModelSerialize(
  ...
  writer.writeString(offsets[1], object.breakInProfile);
  writer.writeDateTime(offsets[2], object.createdAt);
  writer.writeDouble(offsets[3], object.firstOilChangeKm);
  writer.writeBool(offsets[4], object.isFirstLaunch);
  writer.writeDouble(offsets[5], object.manualFuelEconomyKmPerLiter);
  writer.writeLong(offsets[6], object.officeDaysPerWeek);
  writer.writeDouble(offsets[7], object.officeOneWayDistanceKm);
  writer.writeDateTime(offsets[8], object.rebuildDate);
  writer.writeDouble(offsets[9], object.rebuildStartOdometerKm);
...
BikeProfileModel _bikeProfileModelDeserialize(
  ...
  object.breakInProfile = reader.readString(offsets[1]);
  object.createdAt = reader.readDateTime(offsets[2]);
  object.firstOilChangeKm = reader.readDouble(offsets[3]);
  object.id = id;
  object.isFirstLaunch = reader.readBool(offsets[4]);
  object.manualFuelEconomyKmPerLiter = reader.readDouble(offsets[5]);
  object.officeDaysPerWeek = reader.readLong(offsets[6]);
  object.officeOneWayDistanceKm = reader.readDouble(offsets[7]);
  object.rebuildDate = reader.readDateTime(offsets[8]);
  object.rebuildStartOdometerKm = reader.readDouble(offsets[9]);
